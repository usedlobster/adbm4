<header class="sticky top-0 before:absolute before:inset-0 before:backdrop-blur-md before:bg-white/90 dark:before:bg-gray-800/90 lg:before:bg-gray-100/90 dark:lg:before:bg-gray-900/90 before:-z-10 max-lg:shadow-xs z-30">
    <div class="relative">
        <div class="px-4 sm:px-6 lg:px-8 bg-cover bg-center bg-no-repeat w-full bg-[url('/img/app/bkg.png')] dark:bg-[url('/img/app/bkg-d.png')] border-b-4">
            <div class="flex items-center justify-between h-16 lg:border-b border-gray-200 dark:border-gray-700/60">
                ...
                <div class="flex">
                    ...
                    @if ( !($hide_logos ?? false) )
                        <div class="relative inset-0 flex justify-center items-center overflow-hidden space-x-2 px-2 h-16 ">
                            <img src="/img/app/tmp/dummy_480x96.png" alt="Logo 1" class="h-12 w-auto object-contain flex-1 min-w-24">
                            <img src="/img/app/tmp/dummy_480x96.png" alt="Logo 2" class="h-12 w-auto object-contain flex-1 min-w-24">
                        </div>
                    @endif
                </div>
                ...
                <div class="flex items-center space-x-3">
                    @if ( ($editable ?? false) )
{{--                        @include( 'layouts.app.edit-mode-button' )--}}
                    @endif
                    <!-- Dark / Light toggle -->
                    @include( 'app.darklight')
                    <!-- Avatar -->
{{--                    @include( 'layouts.app.avatar-menu')--}}
